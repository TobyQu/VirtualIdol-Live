...
#         answer_text = get_sys_config().llm_model_driver.chat(prompt=prompt, type=get_sys_config().conversation_llm_model_driver_type, role_name=role_name,
...
#         if answer_text != "":
#             # 保存记忆
#             get_sys_config().memory_storage_driver.save(
